...
/**
 * fill_short_octal_array - converts a binary array to a short octal number
 *
 ...
 */
char *fill_short_octal_array(char *binary_array, char *octal_string)
{
    int operation, i, j, octal_index, limit;

    octal_string[6] = '\0';

    for (i = 15, octal_index = 5; i >= 0; i--, octal_index--)
    {
        if (i > 0)
        {
            limit = 4;
